...
import io.smallbird.modules.sys.entity.ColumnEntity;
import io.smallbird.modules.sys.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		mainPath = StringUtils.isBlank(mainPath) ? "io.smallbird" : mainPath;
