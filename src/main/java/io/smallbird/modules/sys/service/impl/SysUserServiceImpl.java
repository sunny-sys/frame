...
import io.smallbird.common.annotation.DataFilter;
import io.smallbird.common.model.DictionaryService;
...
import io.smallbird.modules.sys.entity.SysDeptEntity;
import io.smallbird.modules.sys.entity.SysUserEntity;
import io.smallbird.modules.sys.service.SysDeptService;
...
public class SysUserServiceImpl extends ServiceImpl<SysUserDao, SysUserEntity> implements SysUserService {
	...
	@Override
	public List<PermListVo> queryAllPermList(Long userId) {
		return baseMapper.queryAllPermList(userId);
	}
}
